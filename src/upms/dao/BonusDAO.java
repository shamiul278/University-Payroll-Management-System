...
public class BonusDAO {
    ...
    public List<Bonus> getAll() {
        ...
        try {
            ...
            ps = c.prepareStatement("SELECT bonus_id, amount, \"TYPE\" AS bonus_type FROM Bonus ORDER BY bonus_id");
            rs = ps.executeQuery();
            while (rs.next())
    ...
    public List<Bonus> getByPayroll(String payrollId) {
        ...
        try {
            ...
            ps = c.prepareStatement(
                "SELECT b.bonus_id, b.amount, b.\"TYPE\" AS bonus_type FROM Bonus b JOIN Payroll_Bonus pb ON b.bonus_id=pb.bonus_id WHERE pb.payroll_id=?");
    ...
    public boolean insert(Bonus b) {
        ...
        try {
            c = DBConnection.getConnection();
            ps = c.prepareStatement("INSERT INTO Bonus (bonus_id, amount, \"TYPE\") VALUES (?,?,?)");
